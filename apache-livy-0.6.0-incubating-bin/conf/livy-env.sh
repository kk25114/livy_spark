...
HADOOP_CONF_DIR=/opt/cloudera/parcels/CDH-6.1.1-1.cdh6.1.1.p0.875250/lib/hadoop/etc/hadoop



# - SPARK_HOME      Spark which you would like to use in Livy.
SPARK_HOME=/opt/cloudera/parcels/CDH-6.1.1-1.cdh6.1.1.p0.875250/lib/spark
...
SPARK_CONF_DIR=/opt/cloudera/parcels/CDH-6.1.1-1.cdh6.1.1.p0.875250/lib/spark/conf
